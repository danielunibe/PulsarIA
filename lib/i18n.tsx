...
const translations = {
  'es-MX': {
    ...
    pasteLinks: 'Pega uno o varios enlaces. Se enlistarán al pulsar el botón y la cola mostrará el proceso en directo.',
  ...
  'en-US': {
    ...
    pasteLinks: 'Paste one or more links. Press the button to add them to the queue and see live progress.',
